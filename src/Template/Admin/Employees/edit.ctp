                        ...
                        <div class="col-lg-6">
                            <fieldset>
                                <?php
                                    ...
                                    echo $this->Form->control('email', ['label' => __('Email'), 'class' => "form-control", "errorClass" => "form-control"]);
                        ...
                        <div class="col-lg-6">
                            <fieldset>
                                <?php
                                    ...
                                    echo $this->Form->control('birthdate', ['class' => "form-control input-date-picker", 'type' => 'text', 'label' => 'Birth date', 'value' => date($appConfData['dateFormat'], strtotime($employee->birthdate))]);
                                    echo $this->Form->control('contract_date', ['class' => "form-control input-date-picker", 'type' => 'text', 'value' => date($appConfData['dateFormat'], strtotime($employee->contract_date))]);
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 pull-right">
                                        <?= $this->Html->image($employee->getPhotoFullPath()); ?>
                                    </div>  
                                </div>
                            </fieldset>
                        </div>
