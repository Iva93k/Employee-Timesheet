    ...
    <div class="col-sm-12">
        <section class="panel">
            <header class="panel-heading">
                <?= __('Work day log') ?>: <?= date($appConfData['dateFormat'], strtotime($workDayLog->work_day)) ?>
            </header>
                ...
                <div class="administrators form large-9 medium-8 columns content">
                    <?= $this->Form->create($workDayLog) ?>
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <?= $this->Form->control('work_day', ['class' => "form-control input-date-picker", 'type' => 'text', 'label' => 'Work day', 'value' => date($appConfData['dateFormat'], strtotime($workDayLog->work_day))]); ?>
                                </div>
                                <div class="col-lg-3">
